...
export default function SofiaXV() {
  ...
  return (
    <div>
      ...
      {/* Mis Padres Section */}
      <section className="relative z-10 w-full bg-gradient-to-b from-[#F5E6D3] via-[#F0D5DD] to-[#F5E6D3] border-t border-[#B76E79]/20 py-12 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h2 className="text-3xl md:text-5xl font-light text-[#b2693f] mb-8 font-playfair">Mis Padres</h2>

          <div className="flex flex-row items-center justify-center">

            <div className="relative p-5 md:p-8 border border-[#B76E79]/25 rounded-3xl bg-[#FDFBF7]/60 backdrop-blur-sm shadow-[0_8px_30px_rgba(183,110,121,0.12)] hover:shadow-[0_14px_40px_rgba(183,110,121,0.22)] hover:border-[#D4AF37]/40 transition-all duration-500 w-36 md:w-64">
              <div className="absolute top-3 left-3 w-4 h-4 border-t border-l border-[#D4AF37]/50 rounded-tl" />
              <div className="absolute top-3 right-3 w-4 h-4 border-t border-r border-[#D4AF37]/50 rounded-tr" />
              <div className="absolute bottom-3 left-3 w-4 h-4 border-b border-l border-[#D4AF37]/50 rounded-bl" />
              <div className="absolute bottom-3 right-3 w-4 h-4 border-b border-r border-[#D4AF37]/50 rounded-br" />
              <p className="font-playfair text-lg md:text-3xl text-[#b2693f] leading-snug">Samuel<br />Becerra</p>
            </div>

            <div className="flex flex-col items-center mx-4 md:mx-6 gap-2">
              <div className="w-px h-8 md:h-12 bg-gradient-to-b from-transparent via-[#B76E79]/30 to-transparent" />
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6 md:w-8 md:h-8 fill-[#B76E79]/50 drop-shadow-sm">
            ...
            <div className="relative p-5 md:p-8 border border-[#B76E79]/25 rounded-3xl bg-[#FDFBF7]/60 backdrop-blur-sm shadow-[0_8px_30px_rgba(183,110,121,0.12)] hover:shadow-[0_14px_40px_rgba(183,110,121,0.22)] hover:border-[#D4AF37]/40 transition-all duration-500 w-36 md:w-64">
              ...
              <div className="absolute bottom-3 left-3 w-4 h-4 border-b border-l border-[#D4AF37]/50 rounded-bl" />
              <div className="absolute bottom-3 right-3 w-4 h-4 border-b border-r border-[#D4AF37]/50 rounded-br" />
              <p className="font-playfair text-lg md:text-3xl text-[#b2693f] leading-snug">Lucina<br />Martínez</p>
            </div>
